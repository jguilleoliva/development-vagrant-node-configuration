...
sudo apt-get -y install wget git vim curl build-essential software-properties-common multitail net-tools bat
...
#--- PHP
# echo "##--- INSTALL-PHP8.1 ---#"
# sudo apt-get install -y php libapache2-mod-php php-common php-curl php-xml php-gd php-imagick php-imap php-intl php-json php-oauth php-mysql php-soap php-cli php-zip php-mbstring
